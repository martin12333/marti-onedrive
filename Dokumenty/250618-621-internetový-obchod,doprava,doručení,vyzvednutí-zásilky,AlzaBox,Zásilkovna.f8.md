---
title: Může zásilku z AlzaBoxu pro mne vyzvednout někdo jiný, když mu sdělím kód pro vyzvednutí?
---
...
Ano, čtete správně, podvodník v tomto případě skutečně za nic nemůže. Ti, kteří na chatech pracují jsou totiž dost možná sami obětmi. Často se totiž jedná o osoby, které jsou někde proti jejich vůli drženy a nuceny pracovat až 16 hodin denně. To vše pod pohrůžkou smrti. Není také výjimkou fyzické násilí hraničící s mučením.

Na veřejnost se dostal například případ indického občana Rakeshe, který se přestěhoval do Thajska s příslibem v práce v IT. Po příjezdu ho však čínský gang převezl do Myanmaru, zbavil dokladů a izoloval od světa. Rakesh se pak musel na sociálních sítích vydávat za atraktivní ruskou ženu a lákat z lidí peníze. Takto byl pro ně nucen pracovat 11 měsíců bez nároku na peněžní odměnu.

===


# https://dostupnyadvokat.cz/blog/podvody-na-internetovych-bazarech

Trvejte na videohovoru: Pokud si chcete být kupujícím jistější, domluvte si s ním videohovor. Pokud by se totiž jednalo o podvod, pravděpodobně jej odmítne.
...
Jsem ochoten za tuto službu dobře zaplatit, protože mi to velmi pomůže. Může to být někdo, koho neznám, ale kdo je spolehlivý a má dobré reference.

Kde bych takového kurýra našel?  SuperSoused.cz ? Messenger.cz ?  Existuje nějaká náhrada za zrušené Zavezu.cz ?

// V tomto roce to nemůže to být někdo z rodiny, kamarád nebo kolega.
