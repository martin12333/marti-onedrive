...
#psr.exe gonna be deprec, to ~~mp4
...
file:///D:/umarti/dowNLOADS--SYMLINKED/xl/*
works



Step 2: User left click on "Web accessibility (text)" in "Accessibility Internals and 12 more pages - Personal - Microsoft​ Edge"

Program: Microsoft Edge, 135.0.3179.98, Microsoft Corporation, MSEDGE.EXE --PROFILE-DIRECTORY=DEFAULT --RESTART --RESTORE-LAST-SESSION --FLAG-SWITCHES-BEGIN --FLAG-SWITCHES-END, MSEDGE.EXE

Step 1: (‎04/‎29/‎2025 08:09:46) User left click on "Date modified (button)" in "Index of D:\umarti\dowNLOADS--SYMLINKED\ and 14 more pages - Personal - Microsoft​ Edge"
...
User left click on "Highlight selected text (menu item)"
