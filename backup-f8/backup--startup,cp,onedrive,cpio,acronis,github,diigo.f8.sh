...
wsl
	...
	find . -type f -size -2000k -size +100c -mtime -1
...
prepis 22ar
	cd ~/OneDrive
	find . -type f -size -2000k -size +100c -mmin -360   |cpio --verbose  --create --format=crc >/mnt/c/u/cpio/22bb-2000k-mmin--360.cpio
...
##FAIL MOUNT D:/
	...
	find . -type f -size -2000k -size +100c -mtime -1   |cpio --verbose  --create --format=crc >/mnt/d/umarti/cpio/22af-2000k.cpio
# scr shot 200k..800k
